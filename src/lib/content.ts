...
export const aboutPage = {
  ...
  services: {
    ...
    items: [
      ...
      'Profesionalus medinių palangių šlifavimas ir atnaujinimas',
    ],
  },
  history: {
...
export const services = {
  ...
  cards: [
    ...
    },
    {
      ...
      desc: 'Tikslus grindjuosčių pjovimas ir montavimas. Užtikriname estetika ir tvarkingą užbaigimą.',
      price: 'nuo 25 €/val.',
    ...
    },
    {
      ...
      desc: 'Medinių palangių atnaujinimas: įbrėžimų šalinimas, šlifavimas ir padengimas atspariu lakų ar alyva.',
      price: 'pagal užklausą',
...
export const contactInfo = {
  ...
  email: 'mistrasvilnius@gmail.com',
...
export const footer = {
  ...
  servicesColumn: {
    ...
    links: [
      ...
      { label: 'Palangių šlifavimas', href: '/palangiu-slifavimas/' },
      { label: 'Komercinės grindys', href: '/komercines-grindys/' },
      { label: 'Grindjuosčių tvirtinimas', href: '/grindjuosciu-tvirtinimas/' },
    ],
  },
  infoColumn: {
    title: 'Informacija',
