...
export const servicesData: Record<string, ServicePageData> = {
  ...
  'be-dulkiu-slifavimas': {
    ...
    seo: {
      ...
      keyword: 'šlifavimas be dulkių',
    },
    hero: {
      eyebrow: 'Be dulkių šlifavimas',
    ...
    features: {
      sectionTag: 'Technologija',
      headline: 'Kaip veikia mūsų sistema',
      items: [
    ...
    process: {
      sectionTag: 'Procesas',
      headline: 'Šlifavimas be dulkių – kaip tai atrodo',
      steps: [
        { step: 1, icon: '🔧', title: 'Įrangos paruošimas', desc: 'Šlifuoklis prijungiamas prie HEPA dulkių surinkimo sistemos. Patikrinama filtrų būklė prieš kiekvieną darbą.' },
        { step: 2, icon: '🔒', title: 'Sandarios jungtys', desc: 'Visi jungiamieji elementai sandariai užfiksuojami – tai užtikrina, kad nė viena dulkelė nepatektų į orą.' },
        { step: 3, icon: '⚙️', title: 'Šlifavimas', desc: 'Šlifavimas vyksta kaip įprastai, tik visos dulkės akimirksniu surenkamos į rezervuarą.' },
        { step: 4, icon: '✅', title: 'Valymas', desc: 'Po šlifavimo patalpa beveik nereikalauja papildomo valymo – dulkių ant baldų ir grindų praktiškai nėra.' },
      ],
    },
    ba: { location: 'Antakalnis, Vilnius', type: 'Pušies grindys · Alyvavimas Osmo' },
    faq: {
      sectionTag: 'DUK',
      headline: 'Klausimai apie šlifavimą be dulkių',
      items: [
    ...
    cta: {
      headline: 'Šlifavimas be dulkių – susisiekite dabar',
      subtext: 'Nemokama apžiūra ir sąmata. Dirbame visame Vilniuje ir apylinkėse.',
    },
  },
  ...
  'komercines-grindys': {
    ...
    features: {
      ...
      items: [
        ...
        { icon: '🫁', title: 'Be dulkių HEPA sistema', desc: 'Net komercinėse patalpose naudojame HEPA filtravimą – niekas netrukdo veiklai gretimose patalpose.' },
