/**
 * /terasu-atnaujinimas/ — SEO landing page.
 * Target keyword: "terasų atnaujinimas"
 */
import type { Metadata } from 'next'
import { servicesData } from '@/lib/services-data'
import ServicePageTemplate, { type ServicePageData } from '@/components/services/ServicePageTemplate'

const oldData = servicesData['terasu-atnaujinimas']
...
export default function TerasuAtnaujinimasPage() {
